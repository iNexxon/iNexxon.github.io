(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 600, offsetTop = 0) => {
...
*/
        ...
        let sliderContent = document.querySelector(".content-slider__slider");
        let slides = document.querySelectorAll(".slide-content-slider");
        ...
        window.addEventListener("load", (function() {
            setTimeout((() => {
                ...
                setTimeout((() => {
                    ...
                    welcome.querySelector(".graphics").classList.add("_animation");
                    welcome.querySelector(".content-welcome__title").classList.add("_animation");
                    welcome.querySelector(".content-welcome__text").classList.add("_animation");
                    welcome.querySelector(".content-welcome__btn").classList.add("_animation");
                    welcome.querySelector(".content-welcome__border").classList.add("_animation");
                    welcome.querySelector(".video-welcome").classList.add("_animation");
        ...
        function initSlider() {
            ...
            activeSlide = new Proxy(activeSlide, {
